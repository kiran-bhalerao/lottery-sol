...
impl PrintProgramError for AppError {
        ...
        E: 'static + std::error::Error + DecodeError<E> + PrintProgramError + FromPrimitive,
    {
        match self {
            ...
            AppError::Unauthorized => msg!("Error: Unauthorized"),
            AppError::LowBalance => msg!("Error: Low Account balance"),
            AppError::DuplicateEntry => msg!("Error: Duplicate Entry"),
            AppError::NoRoom => msg!("Error: No room"),
            AppError::EmptyRoom => msg!("Error: Empty room"),
            AppError::MustSigner => msg!("Error: Account must be signer"),
        }
    }
}
